...
const ButtonToggleGroupStyle = styled.div`
  ...
  `}
`
export const ButtonToggleGroup = ({ children, disabled, fullWidth, type = 'together' }) => {
  return (
    <ButtonToggleGroupStyle $disabled={disabled} fullWidth={fullWidth} $type={type}>
      {

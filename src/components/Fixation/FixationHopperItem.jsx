...
import { getFixationList } from '../../store/slices/fixationSlice';

const FixationStage = styled.div`
...
const FixationHopperItem = ({ hop }) => {
  ...
  const setStageFilter = () => {
    ...
    dispatch(getFixationList({ ...filter, ...hop.filter }));
  };
  return (
    <FixationStage
...
export default FixationHopperItem;

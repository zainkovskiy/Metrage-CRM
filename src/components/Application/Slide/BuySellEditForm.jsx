...
const BuySellEditForm = () => {
  ...
  const method = useForm({
    defaultValues: {
      ...
      AvailableFrom: application?.featureValues?.AvailableFrom || '',
      ClassType: application?.featureValues?.ClassType || '',
      VatType: application?.featureValues?.VatType || '',
      ceilingHeight: application?.featureValues?.ceilingHeight || '',
      WaterPipesCount: application?.featureValues?.WaterPipesCount || '',
    },
  });
  const onSubmit = (data) => {
    dispatch(
